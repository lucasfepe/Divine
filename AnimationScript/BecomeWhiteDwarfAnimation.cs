...
internal class BecomeWhiteDwarfAnimation: MonoBehaviour 
{
    ...
    public void BecomeWhiteDwarf()
    {
        ...
        //ScaleDown(duration, delay, endScaleAmount);
    ...
    private void Hit(float duration, float delay, float endHitBlend, float endHitGlow)
    {
        ...
        DOTween.To(() => 1, x => y = x, 2, waitUntilShowWhiteDwarfIcon).OnComplete(() => AnimationManager.Instance.WhiteDwarfAppear(transform.parent.transform));
    }
